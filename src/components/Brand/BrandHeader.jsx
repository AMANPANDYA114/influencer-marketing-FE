...
const BrandHeader = (props) => {
  ...
  const [brandData, setBrandData] = useState({
    logo: logo, // Use the actual path to your dummy logo or replace it with a placeholder
    uname: "Brand Name", // Dummy username
  });

  useEffect(() => {
    // Instead of API call, we just set dummy data
    setBrandData({
      logo: logo, // Dummy logo
      uname: "Brand Name", // Dummy username
    });
  }, []);
    ...
    <div className="h-20 flex items-center border-b-2 justify-between mx-20 w-[screen]">
      ...
      <div className="flex items-center">
        <div className="flex items-center space-x-4">
          <div className="">
            <img className="w-10 h-10 rounded-full group" src={brandData.logo} alt="Brand Logo" />
            <div className="absolute hidden group-hover:block">hello</div>
          </div>
