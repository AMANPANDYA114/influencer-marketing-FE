...
const BrandLogin = () => {
  ...
  // Updated postdata function using only axios
  const postdata = async (e) => {
    e.preventDefault();
    const { email, password } = userdata;
  ...
  // Refactor signUp function to use axios
  const signUp = async (values, FormikActions) => {
    const { email, password } = values;
    ...
    <div>
      <div className="bg-white dark:bg-gray-900">
        <div className="flex justify-center h-screen">
          <div className="bg-cover block h-full w-full bg-[url(https://images.unsplash.com/photo-1616763355603-9755a640a287?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&)]">
              ...
              <div className="flex items-center p-5 rounded-lg mx-auto bg-opacity-25 bg-white">
                <div className="flex-1">
                  <div className="text-center item-center">
                    <p className="pb-5 text-white text-xl font-bold dark:text-gray-300">Sign in to access your account as</p>
                    <div className="mt-3 md:flex md:items-center md:-mx-2">
                      <NavLink to="/InfluencerLogin">
                      ...
                      <NavLink to="/BrandLogin">
                        <button className={deactivebtn}>
                          <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.7 0-7-1.114-9.5-3.255" />
                          </svg>
                      ...
                      <form method="POST">
                        ...
                        <div className="mt-6">
                          <div className="flex justify-between">
                            ...
                            <a href="#" className="text-sm text-white focus:text-blue-500 hover:text-blue-500 hover:underline">
                              Forgot password?
                            </a>
                          </div>
                          <div className="flex flex-row">
                            ...
                            <div className="cursor-pointer my-auto mx-1" onClick={togglePassword}>
                              {passwordType === 'password' ? (
                                <AiFillEye className="dark:text-white text-white" size={25} />
                              ) : (
                                <AiFillEyeInvisible size={25} className="dark:text-white text-white" />
                              )}
                            </div>
                          </div>
                  ...
                  <p className="mt-6 text-lg text-center text-white">
                    ...
                    <a href="BrandSignUp" className="font-bold text-blue-300 focus:outline-none focus:underline hover:underline">
                      Sign up
                    </a>
                  </p>
                </div>
