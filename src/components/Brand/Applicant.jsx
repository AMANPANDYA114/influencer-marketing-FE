...
//              <p className="text-blue-500 text-sm underline mt-2 break-all">                <strong>Task Link:</strong> <a href={applicant.taskLink} target="_blank" rel="noopener noreferrer">{applicant.taskLink}</a>
//              </p>
