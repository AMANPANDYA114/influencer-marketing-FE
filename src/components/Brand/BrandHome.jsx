...
const  BrandHome= () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex h-screen mb-0 justify-center">
        <div className="flex-1 overflow-y-auto p-4 mb-0 w-full max-w-7xl">
          {/* <BrandHeader page="brand home" /> */}
  
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-center text-black mt-[50px] mb-[50px] cursor-pointer hover:text-gray-700 transition-all duration-300 ease-in-out transform hover:scale-105 break-words">
            Start Searching Influencers from a Large Database
            <span className="block text-base sm:text-sm md:text-base lg:text-lg font-normal text-gray-600 mt-0 ml-[20px] sm:ml-0 break-words">
              Discover top influencers to elevate your brand's reach and impact.
            </span>
...
{/* Container for BrandList and Filter Button */}
<div className="relative flex justify-start items-center space-x-2 mt-[0%] mb-0">
  {/* BrandList Component */}
...
<div className="mt-4">
  <button
    ...
    onMouseOver={(e) => e.target.style.backgroundColor = '#2563EB'} // Hover effect (blue-600)
    onMouseOut={(e) => e.target.style.backgroundColor = '#1D4ED8'} // Reset hover effect (blue-700)
  >
    Export Selected Rows as CSV
  </button>
</div>
          ...
          {/* Table */}
          <div className="relative w-full shadow-md sm:rounded-lg max-h-[calc(100vh-250px)] mt-[10%] mb-0">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <thead className="text-xs text-black uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  <th scope="col" className="px-6 py-3 whitespace-nowrap">
