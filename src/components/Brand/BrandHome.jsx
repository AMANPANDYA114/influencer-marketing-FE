...
const BrandHome = () => {
  ...
  // Mock influencer data (replace this with real data as needed)
  const mockData = [
    {
      id: 1,
      name: "Influencer 1",
    ...
    // Add more mock influencers if necessary
  ];

  // Simulate loading state with mock data
  useEffect(() => {
    setTimeout(() => {
      setprofilecard(mockData);  // Set the mock data after loading
      setloading(false);  // Hide loader after data is set
    }, 2000);  // Simulate a delay like fetching data from an API
  }, []);
            ...
            <nav aria-label="Page navigation example">
              <ul className="flex list-style-none">
                ...
                <li className="page-item">
                  <a className="page-link relative block py-1.5 px-3 border-0 bg-transparent text-gray-800 outline-none transition-all duration-300 rounded hover:text-gray-800 hover:bg-gray-200 focus:shadow-none">
                    1
                  </a>
                </li>
                <li className="page-item active">
                  <a className="page-link relative block py-1.5 px-3 border-0 bg-blue-600 text-white outline-none transition-all duration-300 rounded hover:text-gray-800 hover:bg-gray-200 focus:shadow-none">
                    2
                  </a>
                </li>
                <li className="page-item">
