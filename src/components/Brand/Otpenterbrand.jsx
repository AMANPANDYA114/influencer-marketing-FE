...
const OtpEnterBrand = () => {
  ...
  useEffect(() => {
    if (!email) {
      navigate('/brandemail'); // If no email, redirect back to the email page
    }
  }, [email, navigate]);
