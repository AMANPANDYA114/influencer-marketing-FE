...
//       try {
//         const res = await axios.get('https://server-side-influencer.onrender.com/manager/managers/mabgerid ');
...
const ManagerHeader = (props) => {
  ...
  // Fetch manager data on component mount
  useEffect(() => {
    const managerId = localStorage.getItem('managerID'); // Retrieve managerId from localStorage
    ...
    const fetchManagerData = async () => {
      try {
        const res = await axios.get(`https://server-side-influencer.onrender.com/manager/managers/${managerId}`); // Fetch manager data using managerId
        console.log("Manager Data Header Response:", res); 
