...
//           "http://localhost:8000/brand/getAllCampaigns"
//         );
...
//         ) : (
//           <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 px-10 gap-y-10 max-sm:px-5">
//             {displayedCampaigns.length > 0 ? (
//               displayedCampaigns.map((campaign) => (
//                 <div
//                   key={campaign._id}
//                   className="cursor-pointer mt-10 items-center justify-center border-2 border-gray-300 shadow-2xl bg-gray-100 rounded-2xl overflow-hidden"
