...
//   const [campaignsPerPage, setCampaignsPerPage] = useState(3); // Default to 3 cards per page (mobile/tablet)
//   const navigate = useNavigate();
...
//   useEffect(() => {
//     getCampaigns();
//     // Adjust campaigns per page based on screen width
//     const handleResize = () => {
//       if (window.innerWidth >= 1024) { // Large screen (desktop)
//         setCampaignsPerPage(6);
//       } else { // Mobile/Tablet screen
//         setCampaignsPerPage(3);
//       }
//     };
...
//     // Add resize event listener to adjust layout dynamically
...
//   const currentCampaigns = displayedCampaigns.slice(indexOfFirstCampaign, indexOfLastCampaign); // Get the current campaigns for this page
...
//   const totalPages = Math.ceil(displayedCampaigns.length / campaignsPerPage);
