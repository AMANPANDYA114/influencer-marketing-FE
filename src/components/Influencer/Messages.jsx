...
const MessageBox = () => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '' }}>
      ...
      {/* Sidebar (Navbar) */}
      <div style={{
        width: '0px', // Adjusted the width of the sidebar to match the Navbar
        backgroundColor: 'rgba(255, 255, 255, 0.7)', // Transparent white background
        color: '#fff',
        padding: '20px',
        borderRadius: '8px',
      ...
      <div style={{
        flex: 1,
        padding: '20px',
        marginLeft: '270px', // Ensures the content doesn't overlap with the navbar (adjusted to match the sidebar width)
      }}>
        {/* Heading for Influencers to Connect with Brands */}
        <div style={{
          textAlign: 'center',
